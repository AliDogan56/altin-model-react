...
# Gizli anahtarlar profil dosyasında değil, git dışı .env.secrets içinde (LLM anahtarları, yönetici token'ı).
load_dotenv(Path(__file__).with_name(".env.secrets"), override=False)
