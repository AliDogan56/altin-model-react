...
Bu modül teknik analiz paketinin gün içi SEANS bloğudur (eski `momentum_service`).
Matematiği ölçülmüştür ve `tests/test_technical_session_fixture.py` ile bit-bit
sabitlenmiştir; tüm sabitler ileride paket yapılandırması üzerinden sunulacaktır.
