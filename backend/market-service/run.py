...
if __name__ == "__main__":
    # IntelliJ/PyCharm pydevd bir trace fonksiyonu bağlar. Bunu otomatik
    # algılamak, IDE ortam değişkenini aktarmasa bile reload alt sürecinin
    # breakpoint bağlantısını koparmasını önler.
