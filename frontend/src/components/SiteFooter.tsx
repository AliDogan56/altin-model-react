...
function SiteFooter() {
  return <footer className="site-footer" id="risk-notu">
    <div className="footer-grid">
      ...
      <nav aria-label="Footer hızlı bağlantılar"><h2>Platform</h2><a href="/#panel">Canlı ons paneli</a><Link to="/yorum">Bugünkü AI yorumu</Link><a href="/#feature-tahmin">Altın tahminleri</a><Link to="/rehber">Tüm altın rehberleri</Link><a href="/sitemap.xml">Site haritası</a></nav>
